...
COMPILE_CMD="pnut-ts -d --cache --cache-dir $CACHE_DIR -I $SRC_PATH -I $UTILS_PATH -I $DEMO_PATH -I $REGTEST_PATH -I $REF_SD_SRC -I $REF_SD_UTILS -I $REF_SD_DEMO $BASENAME.spin2"
